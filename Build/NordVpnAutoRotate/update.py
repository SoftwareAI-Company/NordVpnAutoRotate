...
if Y:
    ...
    if ver_true == True: 
        ...
        comando_terminal = ['start', 'NordVpnAutoRotate/Python/pythonw', f'NordVpnAutoRotate/Versions/Version_{nova_versao}/main.py']
    ...
    comando_terminal = ['start', 'NordVpnAutoRotate/Python/pythonw', f'NordVpnAutoRotate/Versions/Version_{versao_atual}/main.py']
